...
import { loginApiUser } from '@/api/modules'
      ...
      <VCard flat :max-width="600" class="mt-12 mt-sm-0 pa-6">
        <div class="d-flex justify-center">
          <VCardText class=" pb-0">
            <h1 class="d-flex justify-center text-h1 mb-1 text-black">
              ¡Hola!
            </h1>
          </VCardText>
        ...
        <VCardText class=" pt-0">
          ...
          <VCol cols="12" class="px-0 py-0">
            ...
            <RouterLink class="text-gold ms-2" :to="{ name: 'register' }">
              Crea una cuenta
            </RouterLink>
          </VCol>
        </VCardText>
          ...
          <VForm ref="refVForm" @submit.prevent="onSubmit">
            ...
            <VRow>
              ...
              <VCol cols="12">
                ...
                <VBtn block type="submit" rounded="pill">
                  <a class="font-weight-bold text-black">INICIAR SESIÓN</a>
                </VBtn>
              </VCol>

              <VCol cols="12" class="d-flex flex-row justify-center align-center">
                <VDivider class="mx-6" />

                <div style="flex: none">
                  <span class="text-black font-weight-100">O registrate con</span>
                </div>
