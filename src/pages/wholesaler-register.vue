...
const storename = ref('acwedding')
const phonenumber = ref(2025550111)
const salespermission = ref('')
      ...
      <VCard flat :max-width="600" class="mt-12 mt-sm-0 pa-6">
        ...
        <VCardText class="pt-0">
          <VCol cols="12" class="px-0 py-0">
            ...
            <a class="text-black ms-2" href="#"> ¿Quiero ser mayorista? </a>
          </VCol>
        </VCardText>
